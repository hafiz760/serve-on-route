...
function SelectVehicle(params) {
  ...
  const fetchData = async () => {
    setISLoading(true);
      if (
      !params?.route?.params?.form?.locationName ||
      !params?.route?.params?.to?.locationName ||
      !params?.route?.params?.form?.latitude ||
      !params?.route?.params?.form?.longitude ||
      !params?.route?.params?.to?.latitude ||
      !params?.route?.params?.to?.longitude ||
      !height?.title ||
      !width?.title ||
      !length?.title ||
      !fare ||
