...
const Left = props => {
  ...
  if (props.leftContent) {
    ...
    C = (
      <Button style={styles.btn} onPress={props.onPressLeft || goBack}>
        <Icon
          name="arrow-left"
          type="Feather"
  ...
  return (
    <View
      style={props.leftStyle ? [styles.left, props.leftStyle] : styles.left}>
      {C}
    </View>
  );
};
const Right = props => {
    ...
    C = (
      <Button style={styles.btn1}>
        ...
        <Icon
          name="bell"
          type="Feather"
          style={[theme.SIZE_24, theme.LIGHT, styles.iconStyle]}
        />
      </Button>
    );
  }
  return (
    <View
      style={
        props.rightStyle ? [styles.right, props.rightStyle] : styles.right
      }>
      {C}
    </View>
  );
...
const Middle = props => {
  ...
  return (
    <View
      style={
        props.middleStyle ? [styles.middle, props.middleStyle] : styles.middle
      }>
      {C}
    </View>
  );
...
const containerHeight =
  Platform.OS === 'ios'
    ? themePlatform.toolbarHeight + 10
    : themePlatform.toolbarHeight;
